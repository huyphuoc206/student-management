...
<body>
	...
	<div class="d-sm-flex align-items-center justify-content-center mb-4">
		<h1 class="h3 mb-0 text-gray-800">Cập nhật môn học</h1>
	</div>
	<form id="formSubmit">
		...
		<div class="form-group row justify-content-center">
			<label for="facultyList" class="col-sm-2 col-form-label">Khoa</label>
			<div class="col-sm-6">
		...
		<div class="form-group row justify-content-center">
			<label for="departmentList" class="col-sm-2 col-form-label">Bộ môn</label>
			<div class="col-sm-6">
