...
<body>
	<a href="student.html" class="btn btn-info btn-icon-split mb-3"> <span
	...
	<form>
		...
		<div class="form-row">
			...
			<div class="form-group col-md-6">
				<label for="">Lớp</label> <select id="" class="form-control">
					<option>DH18DTB</option>
					<option>DH18DTC</option>
				</select>
			</div>
		</div>
		<div class="form-row">
