 ...
 <ul
      ...
      >
        ...
        <!-- <li class="nav-item active">
          <a class="nav-link" href="update-information.html">
        ...
        <li class="nav-item">
          <a class="nav-link" href="student-score.html">
        ...
        <li class="nav-item">
          <a class="nav-link" href="lecturer-subject.html">
            <i class="fas fa-fw fa-book"></i>
            <span>Danh sách môn học</span></a
          >
        </li> -->
        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              <a class="collapse-item" href="admin.html">Quản trị viên</a>
              <a class="collapse-item" href="lecturer.html">Giảng viên</a>
